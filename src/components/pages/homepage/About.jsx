  ...
  return (
    <div className="mt-[10rem] mb-[15rem] max-md:my-[5rem]">
      ...
      <div className="flex justify-center items-center">
        ...
        />
        <div className="flex gap-5 justify-center mx-10 pl-16 text-lg font-bold border border-amber-700 border-solid hover:bg-green-600 hover:border-white hover:text-white max-w-[33.438rem] rounded-[50px] text-neutral-700 max-md:pl-5 max-md:mt-10">
