        ...
        <div className="mt-10 w-full max-md:mt-10 max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow px-5 py-16 w-full bg-orange-50 rounded-2xl border border-red-500 border-solid max-md:pl-5 max-md:mt-3">
                <img
                  loading="lazy"
            ...
            <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow px-6 py-16 w-full bg-orange-50 rounded-2xl border border-red-500 border-solid max-md:px-5 max-md:mt-3">
                <img
                  loading="lazy"
            ...
            <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow px-6 py-20 w-full bg-orange-50 rounded-2xl border border-red-500 border-solid max-md:pl-5 max-md:mt-3">
                <img
                  loading="lazy"
