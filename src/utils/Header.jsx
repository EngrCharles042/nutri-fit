      ...
      <div className="flex justify-center items-center px-16 py-10 w-full max-md:px-5 max-md:max-w-full">
        <div className="flex justify-between gap-5 w-full max-w-[1239px] max-md:flex-wrap max-md:max-w-full">
          ...
          <div className="flex gap-10 items-center text-lg font-medium text-zinc-800 max-md:flex-wrap max-md:max-w-full max-md:hidden">
            <Link to="/exercise" className="hover:text-white hover:bg-amber-700 rounded-xl px-3 py-5 self-stretch my-auto cursor-pointer">
              Exercises{" "}
            </Link>

            <div className="hover:text-white hover:bg-amber-700 rounded-xl px-3 py-5 self-stretch my-auto cursor-pointer">
              Allergy-friendly Recipes
            </div>
            <div className="hover:text-white hover:bg-amber-700 rounded-xl px-3 py-5 self-stretch my-auto cursor-pointer">Meal Plans</div>
            <div className="hover:text-white hover:bg-amber-700 rounded-xl px-3 py-5 self-stretch my-auto cursor-pointer">Community</div>
