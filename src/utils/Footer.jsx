        ...
        <div className="flex gap-5 justify-between items-start px-5 w-full max-w-[1241px] max-md:flex-wrap max-md:max-w-full">
          ...
          <div className="flex flex-col self-stretch font-bold max-md:max-w-full">
            ...
            <div className="flex flex-col self-end px-px mt-16 max-w-full w-[463px] max-md:mt-10">
              ...
              <div className="flex gap-5 justify-center py-2 pr-2 pl-8 mt-6 text-2xl border border-white border-solid rounded-[50px] max-md:flex-wrap max-md:pl-5 max-md:max-w-full">
